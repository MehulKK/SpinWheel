...
final class MWheelView extends View {
    ...
    public MWheelView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MWheelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setWheelListener(WheelListener onLuckyWheelReachTheTarget) {
        ...
        animate().setInterpolator(new DecelerateInterpolator())
                ...
                .setListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (mWheelListener != null) {
                            mWheelListener.onReward(target);
                        }
