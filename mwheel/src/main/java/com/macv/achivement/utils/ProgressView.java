...
public interface ProgressView {
    ...
    String KEY_USER_PROGRESS = "com.macv.api.view.KEY_USER_PROGRESS";
    String KEY_DRAWN_PROGRESS = "com.macv.api.view.KEY_DRAWN_PROGRESS";
    String KEY_STRIPED = "com.macv.api.view.KEY_STRIPED";
    String KEY_ANIMATED = "com.macv.api.view.KEY_ANIMATED";
